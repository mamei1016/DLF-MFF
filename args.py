...
def add_train_argument(p):
    ...
    p.add_argument('--split_type',type=str,choices=['random', 'scaffold','balanced'],default='random',
    ...
    p.add_argument('--hidden_size',type=int,default=128,
                   help='The dim of hidden dim in model fpn.')
    p.add_argument('--fp_2_dim',type=int,default=256,
                   help='The dim of the second layer in fpn.')
    p.add_argument('--dropout_fpn',type=float,default=0.2,
                   help='The dropout of fpn and ffn.')
    p.add_argument('--dropout_gnn',type=float,default=0.05,
                   help='The dropout of gnn.')
    p.add_argument('--dropout_egnn', type=float, default=0.45,
                   help='The dropout of egnn.')
    p.add_argument('--emb_dim_gnn', type=int, default=32,
                        help='embedding dimensions of gnn (default: 300)')
    p.add_argument('--hidden_gnn', type=int, default=128,
                   help='The hidden dimension in gnn.')
    p.add_argument('--emb_egnn', type=int, default=64,
                   help='embedding dimensions of egnn (default: 300)')
    p.add_argument('--linear_dim', type=int, default=64,
...
def add_hyper_argument(p):
    ...
    p.add_argument('--model_path', type=str, default='hyper_model_save',
                   help='The path to save output model.pt.,default is "hyper_model_save/"')
